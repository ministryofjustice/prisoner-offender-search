...
class HMPPSDomainEventListener(
  ...
  @SqsListener("hmppsdomainqueue", factory = "hmppsQueueContainerFactoryProxy", maxMessagesPerPoll = "1", maxInflightMessagesPerQueue = "1")
  fun processDomainEvent(requestJson: String?) {
    try {
      ...
      when (eventType) {
        "incentives.iep-review.inserted", "incentives.iep-review.updated", "incentives.iep-review.deleted", "incentives.prisoner.next-review-date-changed" ->
